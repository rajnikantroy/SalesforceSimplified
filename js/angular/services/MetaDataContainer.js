app.service('MetaDataContainer', ['UserId',  function(UserId) {
    this.data = [
    {
        ...
        queryForAll:"SELECT Id, Label, Name, LastModifiedBy.name FROM PermissionSet order by LastModifiedDate desc",
        queryForAllWithWhere:"SELECT Id, Label, Name, LastModifiedBy.name FROM PermissionSet where name like ",
        query:"SELECT Id, Label, Name, LastModifiedBy.name FROM PermissionSet where LastModifiedById='"+UserId.id+"' or CreatedById='"+UserId.id+"' order by LastModifiedDate desc",
        ...
        eligibleForPackageXml:true,
        dataNotAvailableMessage:"You have not created/modified any permission set.",
        queryForAll:"SELECT Id, DeveloperName, MasterLabel, LastModifiedBy.name FROM PermissionSetGroup order by LastModifiedDate desc",
        queryForAllWithWhere:"SELECT Id, DeveloperName, MasterLabel, LastModifiedBy.name FROM PermissionSetGroup where name like ",
        query:"SELECT Id, DeveloperName, MasterLabel, LastModifiedBy.name FROM PermissionSetGroup where LastModifiedById='"+UserId.id+"' or CreatedById='"+UserId.id+"' order by LastModifiedDate desc",
